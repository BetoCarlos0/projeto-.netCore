...
namespace VCommerce.IdentityServer.Configuration;
...
public class IdentityConfiguration
{
    ...
    public static IEnumerable<ApiScope> ApiScopes => new List<ApiScope>
    {
        ...
        new ApiScope("vcommerce", "VCommerce Server"),
    ...
    public static IEnumerable<Client> Clients => new List<Client>
    {
        ...
        new Client
        {
            ...
            RedirectUris = {"https://localhost:7158/signin-oidc"},//login
            PostLogoutRedirectUris = {"https://localhost:7158/signout-callback-oidc"},//logout
