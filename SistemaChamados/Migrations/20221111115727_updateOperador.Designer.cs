...
namespace SistemaChamados.Migrations
{
    ...
    [Migration("20221111115727_updateOperador")]
    partial class updateOperador
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaChamados.Data.Identity.UserCustom", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SistemaChamados.Models.Calls", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SistemaChamados.Data.Identity.UserCustom", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaChamados.Models.Calls", b =>
                {
                    b.HasOne("SistemaChamados.Data.Identity.UserCustom", "UserCustom")
                        .WithMany("Calls")
